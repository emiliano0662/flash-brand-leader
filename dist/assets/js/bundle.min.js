...
!function(e,t){"function"==typeof define&&define.amd?define(["jquery"],function(e){return t(e)}):"object"==typeof exports?module.exports=t(require("jquery")):t(jQuery)}(0,function(e){var g;!function(t,e){function r(e,t){this.$form=e,this.$input=t,this.reset(),t.on("change paste",this.reset.bind(this))}var a=function(){return!1},i={numHalted:0,haltValidation:function(e){this.numHalted++,t.formUtils.haltValidation=!0,e.unbind("submit",a).bind("submit",a).find('*[type="submit"]').addClass("disabled").attr("disabled","disabled")},unHaltValidation:function(e){this.numHalted--,0===this.numHalted&&(t.formUtils.haltValidation=!1,e.unbind("submit",a).find('*[type="submit"]').removeClass("disabled").removeAttr("disabled","disabled"))}};r.prototype.reset=function(){this.haltedFormValidation=!1,this.hasRun=!1,this.isRunning=!1,this.result=void 0},r.prototype.run=function(e,t){return"keyup"===e?null:this.isRunning?(this.haltedFormValidation||"submit"!==e||(i.haltValidation(),this.haltedFormValidation=!0),null):this.hasRun?this.result:("submit"===e&&(i.haltValidation(this.$form),this.haltedFormValidation=!0),this.isRunning=!0,this.$input.attr("disabled","disabled").addClass("async-validation"),this.$form.addClass("async-validation"),t(function(e){this.done(e)}.bind(this)),null)},r.prototype.done=function(e){this.result=e,this.hasRun=!0,this.isRunning=!1,this.$input.removeAttr("disabled").removeClass("async-validation"),this.$form.removeClass("async-validation"),this.haltedFormValidation?(i.unHaltValidation(this.$form),this.$form.trigger("submit")):this.$input.trigger("validation.revalidate")},t.formUtils=t.extend(t.formUtils||{},{asyncValidation:function(e,t,a){var i,n=t.get(0);return n.asyncValidators||(n.asyncValidators={}),n.asyncValidators[e]?i=n.asyncValidators[e]:(i=new r(a,t),n.asyncValidators[e]=i),i}})}(e),function(s,e){"use strict";s.fn.validateForm=function(e,t){return s.formUtils.warn("Use of deprecated function $.validateForm, use $.isValid instead"),this.isValid(e,t,!0)},s(window).on("formValidationPluginInit",function(e,t){var a;(function(e){var t={se:"sv",cz:"cs",dk:"da"};if(e.lang in t){var a=t[e.lang];s.formUtils.warn('Deprecated use of lang code "'+e.lang+'" use "'+a+'" instead'),e.lang=a}})(t),(a=t)&&"custom"===a.errorMessagePosition&&"function"==typeof a.errorMessageCustom&&(s.formUtils.warn("Use of deprecated function errorMessageCustom, use config.submitErrorMessageCallback instead"),a.submitErrorMessageCallback=function(e,t){a.errorMessageCustom(e,a.language.errorTitle,t,a)}),function(e){if(e.errorMessagePosition&&"object"==typeof e.errorMessagePosition){s.formUtils.warn("Deprecated use of config parameter errorMessagePosition, use config.submitErrorMessageCallback instead");var t=e.errorMessagePosition;e.errorMessagePosition="top",e.submitErrorMessageCallback=function(){return t}}}(t)}).on("validatorsLoaded formValidationSetup",function(e,t){var o,a;t||(t=s("form")),(a=(o=t).find("[data-validation-if-checked]")).length&&s.formUtils.warn('Detected use of attribute "data-validation-if-checked" which is deprecated. Use "data-validation-depends-on" provided by module "logic"'),a.on("beforeValidation",function(){var e=s(this),t=e.valAttr("if-checked"),a=s('input[name="'+t+'"]',o),i=a.is(":checked"),n=(s.formUtils.getValue(a)||"").toString(),r=e.valAttr("if-checked-value");(!i||r&&r!==n)&&e.valAttr("skipped",!0)})})}(e),function(d){"use strict";var n={resolveErrorMessage:function(e,t,a,i,n){var r=i.validationErrorMsgAttribute+"-"+a.replace("validate_",""),o=e.attr(r);return o||((o=e.attr(i.validationErrorMsgAttribute))||((o="function"!=typeof t.errorMessageKey?n[t.errorMessageKey]:n[t.errorMessageKey(i)])||(o=t.errorMessage))),o},getParentContainer:function(e){if(e.valAttr("error-msg-container"))return d(e.valAttr("error-msg-container"));var t=e.parent();if(!t.hasClass("form-group")&&!t.closest("form").hasClass("form-horizontal")){var a=t.closest(".form-group");if(a.length)return a.eq(0)}return t},applyInputErrorStyling:function(e,t){e.addClass(t.errorElementClass).removeClass("valid"),this.getParentContainer(e).addClass(t.inputParentClassOnError).removeClass(t.inputParentClassOnSuccess),""!==t.borderColorOnError&&e.css("border-color",t.borderColorOnError)},applyInputSuccessStyling:function(e,t){e.addClass("valid"),this.getParentContainer(e).addClass(t.inputParentClassOnSuccess)},removeInputStylingAndMessage:function(e,t){e.removeClass("valid").removeClass(t.errorElementClass).css("border-color","");var a=n.getParentContainer(e);if(a.removeClass(t.inputParentClassOnError).removeClass(t.inputParentClassOnSuccess),"function"==typeof t.inlineErrorMessageCallback){var i=t.inlineErrorMessageCallback(e,!1,t);i&&i.html("")}else a.find("."+t.errorMessageClass).remove()},removeAllMessagesAndStyling:function(e,t){if("function"==typeof t.submitErrorMessageCallback){var a=t.submitErrorMessageCallback(e,!1,t);a&&a.html("")}else e.find("."+t.errorMessageClass+".alert").remove();e.find("."+t.errorElementClass+",.valid").each(function(){n.removeInputStylingAndMessage(d(this),t)})},setInlineMessage:function(t,a,i){this.applyInputErrorStyling(t,i);var n,e=document.getElementById(t.attr("name")+"_err_msg"),r=!1,o=function(e){d.formUtils.$win.trigger("validationErrorDisplay",[t,e]),e.html(a)},s=function(){var e=!1;r.find("."+i.errorMessageClass).each(function(){if(this.inputReferer===t[0])return e=d(this),!1}),e?a?o(e):e.remove():""!==a&&(n=d('<div class="'+i.errorMessageClass+' alert"></div>'),o(n),n[0].inputReferer=t[0],r.prepend(n))};if(e)d.formUtils.warn("Using deprecated element reference "+e.id),r=d(e),s();else if("function"==typeof i.inlineErrorMessageCallback){if(!(r=i.inlineErrorMessageCallback(t,a,i)))return;s()}else{var l=this.getParentContainer(t);0===(n=l.find("."+i.errorMessageClass+".help-block")).length&&(n=d("<span></span>").addClass("help-block").addClass(i.errorMessageClass)).appendTo(l),o(n)}},setMessageInTopOfForm:function(e,t,a,i){var n='<div class="{errorMessageClass} alert alert-danger"><strong>{errorTitle}</strong><ul>{fields}</ul></div>',r=!1;if("function"!=typeof a.submitErrorMessageCallback||(r=a.submitErrorMessageCallback(e,t,a))){var o={errorTitle:i.errorTitle,fields:"",errorMessageClass:a.errorMessageClass};d.each(t,function(e,t){o.fields+="<li>"+t+"</li>"}),d.each(o,function(e,t){n=n.replace("{"+e+"}",t)}),r?r.html(n):e.children().eq(0).before(d(n))}}};d.formUtils=d.extend(d.formUtils||{},{dialogs:n})}(e),function(f,u,e){"use strict";var n=0;f.fn.validateOnBlur=function(a,i){var n=this,e=this.find("*[data-validation]");return e.each(function(){var e=f(this);if(e.is("[type=radio]")){var t=n.find('[type=radio][name="'+e.attr("name")+'"]');t.bind("blur.validation",function(){e.validateInputOnBlur(a,i,!0,"blur")}),i.validateCheckboxRadioOnClick&&t.bind("click.validation",function(){e.validateInputOnBlur(a,i,!0,"click")})}}),e.bind("blur.validation",function(){f(this).validateInputOnBlur(a,i,!0,"blur")}),i.validateCheckboxRadioOnClick&&this.find("input[type=checkbox][data-validation],input[type=radio][data-validation]").bind("click.validation",function(){f(this).validateInputOnBlur(a,i,!0,"click")}),this},f.fn.validateOnEvent=function(a,i){return("FORM"===this[0].nodeName?this.find("*[data-validation-event]"):this).each(function(){var e=f(this),t=e.valAttr("event");t&&e.unbind(t+".validation").bind(t+".validation",function(e){9!==(e||{}).keyCode&&f(this).validateInputOnBlur(a,i,!0,t)})}),this},f.fn.showHelpOnFocus=function(e){return e||(e="data-validation-help"),this.find("textarea,input").each(function(){var t=f(this),a="jquery_form_help_"+ ++n,i=t.attr(e);t.removeClass("has-help-text").unbind("focus.help").unbind("blur.help"),i&&t.addClass("has-help-txt").bind("focus.help",function(){var e=t.parent().find("."+a);0===e.length&&(e=f("<span />").addClass(a).addClass("help").addClass("help-block").text(i).hide(),t.after(e)),e.fadeIn()}).bind("blur.help",function(){f(this).parent().find("."+a).fadeOut("slow")})}),this},f.fn.validate=function(a,i,e){var n=f.extend({},f.formUtils.LANG,e||{});this.each(function(){var e=f(this),t=(e.closest("form").get(0)||{}).validationConfig||{};e.one("validation",function(e,t){"function"==typeof a&&a(t,this,e)}),e.validateInputOnBlur(n,f.extend({},t,i||{}),!0)})},f.fn.willPostponeValidation=function(){return(this.valAttr("suggestion-nr")||this.valAttr("postpone")||this.hasClass("hasDatepicker"))&&!u.postponedValidation},f.fn.validateInputOnBlur=function(e,t,a,i){if(f.formUtils.eventType=i,this.willPostponeValidation()){var n=this,r=this.valAttr("postpone")||200;return u.postponedValidation=function(){n.validateInputOnBlur(e,t,a,i),u.postponedValidation=!1},setTimeout(function(){u.postponedValidation&&u.postponedValidation()},r),this}e=f.extend({},f.formUtils.LANG,e||{}),f.formUtils.dialogs.removeInputStylingAndMessage(this,t);var o=this,s=o.closest("form"),l=f.formUtils.validateInput(o,e,t,s,i),d=function(){o.validateInputOnBlur(e,t,!1,"blur.revalidated")};return"blur"===i&&o.unbind("validation.revalidate",d).one("validation.revalidate",d),a&&o.removeKeyUpValidation(),l.shouldChangeDisplay&&(l.isValid?f.formUtils.dialogs.applyInputSuccessStyling(o,t):f.formUtils.dialogs.setInlineMessage(o,l.errorMsg,t)),!l.isValid&&a&&o.validateOnKeyUp(e,t),this},f.fn.validateOnKeyUp=function(a,i){return this.each(function(){var t=f(this);t.valAttr("has-keyup-event")||t.valAttr("has-keyup-event","true").bind("keyup.validation",function(e){9!==e.keyCode&&t.validateInputOnBlur(a,i,!1,"keyup")})}),this},f.fn.removeKeyUpValidation=function(){return this.each(function(){f(this).valAttr("has-keyup-event",!1).unbind("keyup.validation")}),this},f.fn.valAttr=function(e,t){return void 0===t?this.attr("data-validation-"+e):!1===t||null===t?this.removeAttr("data-validation-"+e):(e=0<e.length?"-"+e:"",this.attr("data-validation"+e,t))},f.fn.isValid=function(s,l,a){if(f.formUtils.isLoadingModules){var e=this;return setTimeout(function(){e.isValid(s,l,a)},200),null}l=f.extend({},f.formUtils.defaultConfig(),l||{}),s=f.extend({},f.formUtils.LANG,s||{}),a=!1!==a,f.formUtils.errorDisplayPreventedWhenHalted&&(delete f.formUtils.errorDisplayPreventedWhenHalted,a=!1);var d=function(e,t){f.inArray(e,i)<0&&i.push(e),n.push(t),t.valAttr("current-error",e),a&&f.formUtils.dialogs.applyInputErrorStyling(t,l)},u=[],i=[],n=[],c=this;if(a&&f.formUtils.dialogs.removeAllMessagesAndStyling(c,l),c.find("input,textarea,select").filter(':not([type="submit"],[type="button"])').each(function(){var e,t,a=f(this),i=a.attr("type"),n="radio"===i||"checkbox"===i,r=a.attr("name");if(e=r,!("submit"===(t=i)||"button"===t||"reset"===t||-1<f.inArray(e,l.ignore||[]))&&(!n||f.inArray(r,u)<0)){n&&u.push(r);var o=f.formUtils.validateInput(a,s,l,c,"submit");o.isValid?o.isValid&&o.shouldChangeDisplay&&(a.valAttr("current-error",!1),f.formUtils.dialogs.applyInputSuccessStyling(a,l)):d(o.errorMsg,a)}}),"function"==typeof l.onValidate){var t=l.onValidate(c);f.isArray(t)?f.each(t,function(e,t){d(t.message,t.element)}):t&&t.element&&t.message&&d(t.message,t.element)}return f.formUtils.isValidatingEntireForm=!1,0<n.length&&a&&("top"===l.errorMessagePosition?f.formUtils.dialogs.setMessageInTopOfForm(c,i,l,s):f.each(n,function(e,t){f.formUtils.dialogs.setInlineMessage(t,t.valAttr("current-error"),l)}),l.scrollToTopOnError&&f.formUtils.$win.scrollTop(c.offset().top-20)),!a&&f.formUtils.haltValidation&&(f.formUtils.errorDisplayPreventedWhenHalted=!0),0===n.length&&!f.formUtils.haltValidation},f.fn.restrictLength=function(e){return new f.formUtils.lengthRestriction(this,e),this},f.fn.addSuggestions=function(t){var a=!1;return this.find("input").each(function(){var e=f(this);0<(a=f.split(e.attr("data-suggestions"))).length&&!e.hasClass("has-suggestions")&&(f.formUtils.suggest(e,a,t),e.addClass("has-suggestions"))}),this}}(e,window),function(d){"use strict";d.formUtils=d.extend(d.formUtils||{},{isLoadingModules:!1,loadedModules:{},loadModules:function(t,e,i){if(d.formUtils.isLoadingModules)setTimeout(function(){d.formUtils.loadModules(t,e,i)},10);else{var l=!1,a=function(e,n){var t=d.split(e),a=t.length,r=function(){0===--a&&(d.formUtils.isLoadingModules=!1,i&&l&&"function"==typeof i&&i())};0<a&&(d.formUtils.isLoadingModules=!0);var o="?_="+(new Date).getTime(),s=document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0];d.each(t,function(e,t){if(0===(t=d.trim(t)).length)r();else{var a=n+t+(".js"===t.slice(-3)?"":".js"),i=document.createElement("SCRIPT");a in d.formUtils.loadedModules?r():(d.formUtils.loadedModules[a]=1,l=!0,i.type="text/javascript",i.onload=r,i.src=a+(".dev.js"===a.slice(-7)?o:""),i.onerror=function(){d.formUtils.warn("Unable to load form validation module "+a)},i.onreadystatechange=function(){"complete"!==this.readyState&&"loaded"!==this.readyState||(r(),this.onload=null,this.onreadystatechange=null)},s.appendChild(i))}})};if(e)a(t,e);else{var n=function(){var e=!1;return d('script[src*="form-validator"]').each(function(){if(!(1<this.src.split("form-validator")[1].split("node_modules").length))return"/"===(e=this.src.substr(0,this.src.lastIndexOf("/"))+"/")&&(e=""),!1}),!1!==e&&(a(t,e),!0)};n()||d(n)}}}})}(e),function(r){"use strict";r.split=function(e,a,t){t=void 0===t||!0===t;var i=new RegExp("[,|"+(t?"\\s":"")+"-]\\s*","g");if("function"!=typeof a){if(!e)return[];var n=[];return r.each(e.split(a||i),function(e,t){(t=r.trim(t)).length&&n.push(t)}),n}e&&r.each(e.split(i),function(e,t){if((t=r.trim(t)).length)return a(t,e)})},r.validate=function(n){var e=r.extend(r.formUtils.defaultConfig(),{form:"form",validateOnEvent:!1,validateOnBlur:!0,validateCheckboxRadioOnClick:!0,showHelpOnFocus:!0,addSuggestions:!0,modules:"",onModulesLoaded:null,language:!1,onSuccess:!1,onError:!1,onElementValidate:!1});if(n=r.extend(e,n||{}),r(window).trigger("formValidationPluginInit",[n]),n.lang&&"en"!==n.lang){var t="lang/"+n.lang+".js";n.modules+=n.modules.length?","+t:t}r(n.form).each(function(e,t){t.validationConfig=n;var a=r(t);a.trigger("formValidationSetup",[a,n]),a.find(".has-help-txt").unbind("focus.validation").unbind("blur.validation"),a.removeClass("has-validation-callback").unbind("submit.validation").unbind("reset.validation").find("input[data-validation],textarea[data-validation]").unbind("blur.validation"),a.bind("submit.validation",function(e){var t=r(this),a=function(){return e.stopImmediatePropagation(),!1};if(r.formUtils.haltValidation)return a();if(r.formUtils.isLoadingModules)return setTimeout(function(){t.trigger("submit.validation")},200),a();var i=t.isValid(n.language,n);return r.formUtils.haltValidation?a():i&&"function"==typeof n.onSuccess?!1===n.onSuccess(t)?a():void 0:i||"function"!=typeof n.onError?!!i||a():(n.onError(t),a())}).bind("reset.validation",function(){r.formUtils.dialogs.removeAllMessagesAndStyling(a,n)}).addClass("has-validation-callback"),n.showHelpOnFocus&&a.showHelpOnFocus(),n.addSuggestions&&a.addSuggestions(),n.validateOnBlur&&(a.validateOnBlur(n.language,n),a.bind("html5ValidationAttrsFound",function(){a.validateOnBlur(n.language,n)})),n.validateOnEvent&&a.validateOnEvent(n.language,n)}),""!==n.modules&&r.formUtils.loadModules(n.modules,!1,function(){"function"==typeof n.onModulesLoaded&&n.onModulesLoaded();var e="string"==typeof n.form?r(n.form):n.form;r.formUtils.$win.trigger("validatorsLoaded",[e,n])})}}(e),function(g,t){"use strict";var i=g(t);g.formUtils=g.extend(g.formUtils||{},{$win:i,defaultConfig:function(){return{ignore:[],errorElementClass:"error",borderColorOnError:"#b94a48",errorMessageClass:"form-error",validationRuleAttribute:"data-validation",validationErrorMsgAttribute:"data-validation-error-msg",errorMessagePosition:"inline",errorMessageTemplate:{container:'<div class="{errorMessageClass} alert alert-danger">{messages}</div>',messages:"<strong>{errorTitle}</strong><ul>{fields}</ul>",field:"<li>{msg}</li>"},scrollToTopOnError:!0,dateFormat:"yyyy-mm-dd",addValidClassOnAll:!1,decimalSeparator:".",inputParentClassOnError:"has-error",inputParentClassOnSuccess:"has-success",validateHiddenInputs:!1,inlineErrorMessageCallback:!1,submitErrorMessageCallback:!1}},validators:{},_events:{load:[],valid:[],invalid:[]},haltValidation:!1,addValidator:function(e){var t=0===e.name.indexOf("validate_")?e.name:"validate_"+e.name;void 0===e.validateOnKeyUp&&(e.validateOnKeyUp=!0),this.validators[t]=e},warn:function(e){"console"in t?"function"==typeof t.console.warn?t.console.warn(e):"function"==typeof t.console.log&&t.console.log(e):alert(e)},getValue:function(e,t){var a=t?t.find(e):e;if(0<a.length){var i=a.eq(0).attr("type");return"radio"===i||"checkbox"===i?a.filter(":checked").val()||"":a.val()||""}return!1},validateInput:function(a,i,n,r,o){n=n||g.formUtils.defaultConfig(),i=i||g.formUtils.LANG;var s=this.getValue(a);a.valAttr("skipped",!1).one("beforeValidation",function(){(a.attr("disabled")||!a.is(":visible")&&!n.validateHiddenInputs)&&a.valAttr("skipped",1)}).trigger("beforeValidation",[s,i,n]);var e="true"===a.valAttr("optional"),t=!s&&e,l=a.attr(n.validationRuleAttribute),d=!0,u="",c={isValid:!0,shouldChangeDisplay:!0,errorMsg:""};if(!l||t||a.valAttr("skipped"))return c.shouldChangeDisplay=n.addValidClassOnAll,c;var f=a.valAttr("ignore");return f&&g.each(f.split(""),function(e,t){s=s.replace(new RegExp("\\"+t,"g"),"")}),g.split(l,function(e){0!==e.indexOf("validate_")&&(e="validate_"+e);var t=g.formUtils.validators[e];if(!t)throw new Error('Using undefined validator "'+e+'". Maybe you have forgotten to load the module that "'+e+'" belongs to?');if("validate_checkbox_group"===e&&(a=r.find('[name="'+a.attr("name")+'"]:eq(0)')),("keyup"!==o||t.validateOnKeyUp)&&(d=t.validatorFunction(s,a,n,i,r,o)),!d)return n.validateOnBlur&&a.validateOnKeyUp(i,n),u=g.formUtils.dialogs.resolveErrorMessage(a,t,e,n,i),!1}),!1===d?(a.trigger("validation",!1),c.errorMsg=u,c.isValid=!1,c.shouldChangeDisplay=!0):null===d?c.shouldChangeDisplay=!1:(a.trigger("validation",!0),c.shouldChangeDisplay=!0),"function"==typeof n.onElementValidate&&null!==u&&n.onElementValidate(c.isValid,a,r,u),a.trigger("afterValidation",[c,o]),c},parseDate:function(e,t,a){var i,n,r,o,s=t.replace(/[a-zA-Z]/gi,"").substring(0,1),l="^",d=t.split(s||null);if(g.each(d,function(e,t){l+=(0<e?"\\"+s:"")+"(\\d{"+t.length+"})"}),l+="$",a){var u=[];g.each(e.split(s),function(e,t){1===t.length&&(t="0"+t),u.push(t)}),e=u.join(s)}if(null===(i=e.match(new RegExp(l))))return!1;var c=function(e,t,a){for(var i=0;i<t.length;i++)if(t[i].substring(0,1)===e)return g.formUtils.parseDateInt(a[i+1]);return-1};return r=c("m",d,i),n=c("d",d,i),o=c("y",d,i),!(2===r&&28<n&&(o%4!=0||o%100==0&&o%400!=0)||2===r&&29<n&&(o%4==0||o%100!=0&&o%400==0)||12<r||0===r)&&!(this.isShortMonth(r)&&30<n||!this.isShortMonth(r)&&31<n||0===n)&&[o,r,n]},parseDateInt:function(e){return 0===e.indexOf("0")&&(e=e.replace("0","")),parseInt(e,10)},isShortMonth:function(e){return e%2==0&&e<7||e%2!=0&&7<e},lengthRestriction:function(a,i){var n=parseInt(i.text(),10),r=0,e=function(){var e=a.val().length;if(n<e){var t=a.scrollTop();a.val(a.val().substring(0,n)),a.scrollTop(t)}(r=n-e)<0&&(r=0),i.text(r)};g(a).bind("keydown keyup keypress focus blur",e).bind("cut paste",function(){setTimeout(e,100)}),g(document).bind("ready",e)},numericRangeCheck:function(e,t){var a=g.split(t),i=parseInt(t.substr(3),10);return 1===a.length&&-1===t.indexOf("min")&&-1===t.indexOf("max")&&(a=[t,t]),2===a.length&&(e<parseInt(a[0],10)||e>parseInt(a[1],10))?["out",a[0],a[1]]:0===t.indexOf("min")&&e<i?["min",i]:0===t.indexOf("max")&&i<e?["max",i]:["ok"]},_numSuggestionElements:0,_selectedSuggestion:null,_previousTypedVal:null,suggest:function(t,e,a){var u={css:{maxHeight:"150px",background:"#FFF",lineHeight:"150%",textDecoration:"underline",overflowX:"hidden",overflowY:"auto",border:"#CCC solid 1px",borderTop:"none",cursor:"pointer"},activeSuggestionCSS:{background:"#E9E9E9"}},l=function(e,t){var a=t.offset();e.css({width:t.outerWidth(),left:a.left+"px",top:a.top+t.outerHeight()+"px"})};a&&g.extend(u,a),u.css.position="absolute",u.css["z-index"]=9999,t.attr("autocomplete","off"),0===this._numSuggestionElements&&i.bind("resize",function(){g(".jquery-form-suggestions").each(function(){var e=g(this),t=e.attr("data-suggest-container");l(e,g(".suggestions-"+t).eq(0))})}),this._numSuggestionElements++;var c=function(e){var t=e.valAttr("suggestion-nr");g.formUtils._selectedSuggestion=null,g.formUtils._previousTypedVal=null,g(".jquery-form-suggestion-"+t).fadeOut("fast")};return t.data("suggestions",e).valAttr("suggestion-nr",this._numSuggestionElements).unbind("focus.suggest").bind("focus.suggest",function(){g(this).trigger("keyup"),g.formUtils._selectedSuggestion=null}).unbind("keyup.suggest").bind("keyup.suggest",function(){var a=g(this),i=[],n=g.trim(a.val()).toLocaleLowerCase();if(n!==g.formUtils._previousTypedVal){g.formUtils._previousTypedVal=n;var r=!1,e=a.valAttr("suggestion-nr"),o=g(".jquery-form-suggestion-"+e);if(o.scrollTop(0),""!==n){var s=2<n.length;g.each(a.data("suggestions"),function(e,t){var a=t.toLocaleLowerCase();return a===n?(i.push("<strong>"+t+"</strong>"),r=!0,!1):void((0===a.indexOf(n)||s&&-1<a.indexOf(n))&&i.push(t.replace(new RegExp(n,"gi"),"<strong>$&</strong>")))})}r||0===i.length&&0<o.length?o.hide():0<i.length&&0===o.length?(o=g("<div></div>").css(u.css).appendTo("body"),t.addClass("suggestions-"+e),o.attr("data-suggest-container",e).addClass("jquery-form-suggestions").addClass("jquery-form-suggestion-"+e)):0<i.length&&!o.is(":visible")&&o.show(),0<i.length&&n.length!==i[0].length&&(l(o,a),o.html(""),g.each(i,function(e,t){g("<div></div>").append(t).css({overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",padding:"5px"}).addClass("form-suggest-element").appendTo(o).click(function(){a.focus(),a.val(g(this).text()),a.trigger("change"),c(a)})}))}}).unbind("keydown.validation").bind("keydown.validation",function(e){var t,a,i=e.keyCode?e.keyCode:e.which,n=g(this);if(13===i&&null!==g.formUtils._selectedSuggestion){if(t=n.valAttr("suggestion-nr"),0<(a=g(".jquery-form-suggestion-"+t)).length){var r=a.find("div").eq(g.formUtils._selectedSuggestion).text();n.val(r),n.trigger("change"),c(n),e.preventDefault()}}else{t=n.valAttr("suggestion-nr");var o=(a=g(".jquery-form-suggestion-"+t)).children();if(0<o.length&&-1<g.inArray(i,[38,40])){38===i?(null===g.formUtils._selectedSuggestion?g.formUtils._selectedSuggestion=o.length-1:g.formUtils._selectedSuggestion--,g.formUtils._selectedSuggestion<0&&(g.formUtils._selectedSuggestion=o.length-1)):40===i&&(null===g.formUtils._selectedSuggestion?g.formUtils._selectedSuggestion=0:g.formUtils._selectedSuggestion++,g.formUtils._selectedSuggestion>o.length-1&&(g.formUtils._selectedSuggestion=0));var s=a.innerHeight(),l=a.scrollTop(),d=a.children().eq(0).outerHeight()*g.formUtils._selectedSuggestion;return(d<l||l+s<d)&&a.scrollTop(d),o.removeClass("active-suggestion").css("background","none").eq(g.formUtils._selectedSuggestion).addClass("active-suggestion").css(u.activeSuggestionCSS),e.preventDefault(),!1}}}).unbind("blur.suggest").bind("blur.suggest",function(){c(g(this))}),t},LANG:{errorTitle:"Form submission failed!",requiredField:"This is a required field",requiredFields:"You have not answered all required fields",badTime:"You have not given a correct time",badEmail:"You have not given a correct e-mail address",badTelephone:"You have not given a correct phone number",badSecurityAnswer:"You have not given a correct answer to the security question",badDate:"You have not given a correct date",lengthBadStart:"The input value must be between ",lengthBadEnd:" characters",lengthTooLongStart:"The input value is longer than ",lengthTooShortStart:"The input value is shorter than ",notConfirmed:"Input values could not be confirmed",badDomain:"Incorrect domain value",badUrl:"The input value is not a correct URL",badCustomVal:"The input value is incorrect",andSpaces:" and spaces ",badInt:"The input value was not a correct number",badSecurityNumber:"Your social security number was incorrect",badUKVatAnswer:"Incorrect UK VAT Number",badUKNin:"Incorrect UK NIN",badUKUtr:"Incorrect UK UTR Number",badStrength:"The password isn't strong enough",badNumberOfSelectedOptionsStart:"You have to choose at least ",badNumberOfSelectedOptionsEnd:" answers",badAlphaNumeric:"The input value can only contain alphanumeric characters ",badAlphaNumericExtra:" and ",wrongFileSize:"The file you are trying to upload is too large (max %s)",wrongFileType:"Only files of type %s is allowed",groupCheckedRangeStart:"Please choose between ",groupCheckedTooFewStart:"Please choose at least ",groupCheckedTooManyStart:"Please choose a maximum of ",groupCheckedEnd:" item(s)",badCreditCard:"The credit card number is not correct",badCVV:"The CVV number was not correct",wrongFileDim:"Incorrect image dimensions,",imageTooTall:"the image can not be taller than",imageTooWide:"the image can not be wider than",imageTooSmall:"the image was too small",min:"min",max:"max",imageRatioNotAccepted:"Image ratio is not be accepted",badBrazilTelephoneAnswer:"The phone number entered is invalid",badBrazilCEPAnswer:"The CEP entered is invalid",badBrazilCPFAnswer:"The CPF entered is invalid",badPlPesel:"The PESEL entered is invalid",badPlNip:"The NIP entered is invalid",badPlRegon:"The REGON entered is invalid",badreCaptcha:"Please confirm that you are not a bot",passwordComplexityStart:"Password must contain at least ",passwordComplexitySeparator:", ",passwordComplexityUppercaseInfo:" uppercase letter(s)",passwordComplexityLowercaseInfo:" lowercase letter(s)",passwordComplexitySpecialCharsInfo:" special character(s)",passwordComplexityNumericCharsInfo:" numeric character(s)",passwordComplexityEnd:"."}})}(e,window),(g=e).formUtils.addValidator({name:"email",validatorFunction:function(e){var t=e.toLowerCase().split("@"),a=t[0],i=t[1];if(a&&i){if(0===a.indexOf('"')){var n=a.length;if((a=a.replace(/\"/g,"")).length!==n-2)return!1}return g.formUtils.validators.validate_domain.validatorFunction(t[1])&&0!==a.indexOf(".")&&"."!==a.substring(a.length-1,a.length)&&-1===a.indexOf("..")&&!/[^\w\+\.\-\#\-\_\~\!\$\&\'\(\)\*\+\,\;\=\:]/.test(a)}return!1},errorMessage:"",errorMessageKey:"badEmail"}),g.formUtils.addValidator({name:"domain",validatorFunction:function(e){return 0<e.length&&e.length<=253&&!/[^a-zA-Z0-9]/.test(e.slice(-2))&&!/[^a-zA-Z0-9]/.test(e.substr(0,1))&&!/[^a-zA-Z0-9\.\-]/.test(e)&&1===e.split("..").length&&1<e.split(".").length},errorMessage:"",errorMessageKey:"badDomain"}),g.formUtils.addValidator({name:"required",validatorFunction:function(e,t,a,i,n){switch(t.attr("type")){case"checkbox":return t.is(":checked");case"radio":return 0<n.find('input[name="'+t.attr("name")+'"]').filter(":checked").length;default:return""!==g.trim(e)}},errorMessage:"",errorMessageKey:function(e){return"top"===e.errorMessagePosition||"function"==typeof e.errorMessagePosition?"requiredFields":"requiredField"}}),g.formUtils.addValidator({name:"length",validatorFunction:function(e,t,a,i){var n=t.valAttr("length"),r=t.attr("type");if(void 0===n)return alert('Please add attribute "data-validation-length" to '+t[0].nodeName+" named "+t.attr("name")),!0;var o,s="file"===r&&void 0!==t.get(0).files?t.get(0).files.length:e.length,l=g.formUtils.numericRangeCheck(s,n);switch(l[0]){case"out":this.errorMessage=i.lengthBadStart+n+i.lengthBadEnd,o=!1;break;case"min":this.errorMessage=i.lengthTooShortStart+l[1]+i.lengthBadEnd,o=!1;break;case"max":this.errorMessage=i.lengthTooLongStart+l[1]+i.lengthBadEnd,o=!1;break;default:o=!0}return o},errorMessage:"",errorMessageKey:""}),g.formUtils.addValidator({name:"url",validatorFunction:function(e){if(/^(https?|ftp):\/\/((((\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])(\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])(\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/(((\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/((\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|\[|\]|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#(((\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i.test(e)){var t=e.split("://")[1],a=t.indexOf("/");return-1<a&&(t=t.substr(0,a)),g.formUtils.validators.validate_domain.validatorFunction(t)}return!1},errorMessage:"",errorMessageKey:"badUrl"}),g.formUtils.addValidator({name:"number",validatorFunction:function(e,t,a){if(""!==e){var i,n,r=t.valAttr("allowing")||"",o=t.valAttr("decimal-separator")||a.decimalSeparator,s=!1,l=t.valAttr("step")||"",d=!1;if((t.attr("data-sanitize")||"").match(/(^|[\s])numberFormat([\s]|$)/i)){if(!window.numeral)throw new ReferenceError("The data-sanitize value numberFormat cannot be used without the numeral library. Please see Data Validation in http://www.formvalidator.net for more information.");e.length&&(e=String(numeral().unformat(e)))}if(-1===r.indexOf("number")&&(r+=",number"),-1===r.indexOf("negative")&&0===e.indexOf("-"))return!1;if(-1<r.indexOf("range")&&(i=parseFloat(r.substring(r.indexOf("[")+1,r.indexOf(";"))),n=parseFloat(r.substring(r.indexOf(";")+1,r.indexOf("]"))),s=!0),""!==l&&(d=!0),","===o){if(-1<e.indexOf("."))return!1;e=e.replace(",",".")}if(""===e.replace(/[0-9-]/g,"")&&(!s||i<=e&&e<=n)&&(!d||e%l==0))return!0;if(-1<r.indexOf("float")&&null!==e.match(new RegExp("^([0-9-]+)\\.([0-9]+)$"))&&(!s||i<=e&&e<=n)&&(!d||e%l==0))return!0}return!1},errorMessage:"",errorMessageKey:"badInt"}),g.formUtils.addValidator({name:"alphanumeric",validatorFunction:function(e,t,a,i){var n="^([a-zA-Z0-9",r=t.valAttr("allowing"),o="";if(r){o=n+r+"]+)$";var s=r.replace(/\\/g,"");-1<s.indexOf(" ")&&(s=s.replace(" ",""),s+=i.andSpaces||g.formUtils.LANG.andSpaces),this.errorMessage=i.badAlphaNumeric+i.badAlphaNumericExtra+s}else o=n+"]+)$",this.errorMessage=i.badAlphaNumeric;return new RegExp(o).test(e)},errorMessage:"",errorMessageKey:""}),g.formUtils.addValidator({name:"custom",validatorFunction:function(e,t){return new RegExp(t.valAttr("regexp")).test(e)},errorMessage:"",errorMessageKey:"badCustomVal"}),g.formUtils.addValidator({name:"date",validatorFunction:function(e,t,a){var i=t.valAttr("format")||a.dateFormat||"yyyy-mm-dd",n="false"===t.valAttr("require-leading-zero");return!1!==g.formUtils.parseDate(e,i,n)},errorMessage:"",errorMessageKey:"badDate"}),g.formUtils.addValidator({name:"checkbox_group",validatorFunction:function(e,t,a,i,n){var r=!0,o=t.attr("name"),s=g('input[type=checkbox][name^="'+o+'"]',n),l=s.filter(":checked").length,d=t.valAttr("qty");if(void 0===d){var u=t.get(0).nodeName;alert('Attribute "data-validation-qty" is missing from '+u+" named "+t.attr("name"))}var c=g.formUtils.numericRangeCheck(l,d);switch(c[0]){case"out":this.errorMessage=i.groupCheckedRangeStart+d+i.groupCheckedEnd,r=!1;break;case"min":this.errorMessage=i.groupCheckedTooFewStart+c[1]+i.groupCheckedEnd,r=!1;break;case"max":this.errorMessage=i.groupCheckedTooManyStart+c[1]+i.groupCheckedEnd,r=!1;break;default:r=!0}if(!r){var f=function(){s.unbind("click",f),s.filter("*[data-validation]").validateInputOnBlur(i,a,!1,"blur")};s.bind("click",f)}return r}})});
(function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):e.Sweetalert2=t()})(this,function(){"use strict";function e(e){var t=function e(){for(var t=arguments.length,n=Array(t),o=0;o<t;o++)n[o]=arguments[o];return this instanceof e?void Object.getPrototypeOf(e).apply(this,n):new(Function.prototype.bind.apply(e,[null].concat(n)))};return t.prototype=a(Object.create(e.prototype),{constructor:t}),"function"==typeof Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e,t}function t(){var e=fe.innerParams.get(this),t=fe.domCache.get(this);e.showConfirmButton||(F(t.confirmButton),!e.showCancelButton&&F(t.actions)),S([t.popup,t.actions],R.loading),t.popup.removeAttribute("aria-busy"),t.popup.removeAttribute("data-loading"),t.confirmButton.disabled=!1,t.cancelButton.disabled=!1}function n(){if("undefined"!=typeof window){"undefined"==typeof Promise&&H("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)");for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];if(void 0===t[0])return H("SweetAlert2 expects at least 1 attribute!"),!1;ve=this;var o=Object.freeze(this.constructor.argsToParams(t));Object.defineProperties(this,{params:{value:o,writable:!1,enumerable:!0}});var r=this._main(this.params);fe.promise.set(this,r)}}var M="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},r=function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")},i=function(){function o(e,t){for(var n,o=0;o<t.length;o++)(n=t[o]).enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}return function(e,t,n){return t&&o(e.prototype,t),n&&o(e,n),e}}(),a=Object.assign||function(e){for(var t,n=1;n<arguments.length;n++)for(var o in t=arguments[n])Object.prototype.hasOwnProperty.call(t,o)&&(e[o]=t[o]);return e},s=function e(t,n,o){null===t&&(t=Function.prototype);var r=Object.getOwnPropertyDescriptor(t,n);if(void 0===r){var i=Object.getPrototypeOf(t);return null===i?void 0:e(i,n,o)}if("value"in r)return r.value;var a=r.get;return void 0===a?void 0:a.call(o)},u=function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)},l=function(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t},q=function(e,t){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return function(e,t){var n=[],o=!0,r=!1,i=void 0;try{for(var a,s=e[Symbol.iterator]();!(o=(a=s.next()).done)&&(n.push(a.value),!t||n.length!==t);o=!0);}catch(e){r=!0,i=e}finally{try{!o&&s.return&&s.return()}finally{if(r)throw i}}return n}(e,t);throw new TypeError("Invalid attempt to destructure non-iterable instance")},o="SweetAlert2:",B=function(e){console.warn(o+" "+e)},H=function(e){console.error(o+" "+e)},c=[],d=function(e){-1!==c.indexOf(e)||(c.push(e),B(e))},I=function(e){return"function"==typeof e?e():e},D=function(e){return"object"===(void 0===e?"undefined":M(e))&&"function"==typeof e.then},p=Object.freeze({cancel:"cancel",backdrop:"overlay",close:"close",esc:"esc",timer:"timer"}),f=function(e){var t={};for(var n in e)t[e[n]]="swal2-"+e[n];return t},R=f(["container","shown","height-auto","iosfix","popup","modal","no-backdrop","toast","toast-shown","fade","show","hide","noanimation","close","title","header","content","actions","confirm","cancel","footer","icon","icon-text","image","input","has-input","file","range","select","radio","checkbox","textarea","inputerror","validationerror","progresssteps","activeprogressstep","progresscircle","progressline","loading","styled","top","top-start","top-end","top-left","top-right","center","center-start","center-end","center-left","center-right","bottom","bottom-start","bottom-end","bottom-left","bottom-right","grow-row","grow-column","grow-fullscreen"]),E=f(["success","warning","info","question","error"]),m={previousBodyPadding:null},h=function(e,t){return!!e.classList&&e.classList.contains(t)},N=function(e){if(e.focus(),"file"!==e.type){var t=e.value;e.value="",e.value=t}},g=function(e,t,n){e&&t&&("string"==typeof t&&(t=t.split(/\s+/).filter(Boolean)),t.forEach(function(t){e.forEach?e.forEach(function(e){n?e.classList.add(t):e.classList.remove(t)}):n?e.classList.add(t):e.classList.remove(t)}))},W=function(e,t){g(e,t,!0)},S=function(e,t){g(e,t,!1)},z=function(e,t){for(var n=0;n<e.childNodes.length;n++)if(h(e.childNodes[n],t))return e.childNodes[n]},U=function(e){e.style.opacity="",e.style.display=e.id===R.content?"block":"flex"},F=function(e){e.style.opacity="",e.style.display="none"},P=function(e){for(;e.firstChild;)e.removeChild(e.firstChild)},K=function(e){return e&&(e.offsetWidth||e.offsetHeight||e.getClientRects().length)},O=function(e,t){e.style.removeProperty?e.style.removeProperty(t):e.style.removeAttribute(t)},L=function(){return document.body.querySelector("."+R.container)},v=function(e){var t=L();return t?t.querySelector("."+e):null},Z=function(){return v(R.popup)},Q=function(){return Z().querySelectorAll("."+R.icon)},Y=function(){return v(R.title)},$=function(){return v(R.content)},J=function(){return v(R.image)},X=function(){return v(R.progresssteps)},G=function(){return v(R.confirm)},ee=function(){return v(R.cancel)},te=function(){return v(R.actions)},ne=function(){return v(R.footer)},oe=function(){return v(R.close)},re=function(){var e=Array.prototype.slice.call(Z().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(function(e,t){return e=parseInt(e.getAttribute("tabindex")),(t=parseInt(t.getAttribute("tabindex")))<e?1:e<t?-1:0}),t=Array.prototype.slice.call(Z().querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable], audio[controls], video[controls]'));return function(e){for(var t=[],n=0;n<e.length;n++)-1===t.indexOf(e[n])&&t.push(e[n]);return t}(e.concat(t))},b=function(){return!document.body.classList.contains(R["toast-shown"])},y=function(){return"undefined"==typeof window||"undefined"==typeof document},w=('\n <div aria-labelledby="'+R.title+'" aria-describedby="'+R.content+'" class="'+R.popup+'" tabindex="-1">\n   <div class="'+R.header+'">\n     <ul class="'+R.progresssteps+'"></ul>\n     <div class="'+R.icon+" "+E.error+'">\n       <span class="swal2-x-mark"><span class="swal2-x-mark-line-left"></span><span class="swal2-x-mark-line-right"></span></span>\n     </div>\n     <div class="'+R.icon+" "+E.question+'">\n       <span class="'+R["icon-text"]+'">?</span>\n      </div>\n     <div class="'+R.icon+" "+E.warning+'">\n       <span class="'+R["icon-text"]+'">!</span>\n      </div>\n     <div class="'+R.icon+" "+E.info+'">\n       <span class="'+R["icon-text"]+'">i</span>\n      </div>\n     <div class="'+R.icon+" "+E.success+'">\n       <div class="swal2-success-circular-line-left"></div>\n       <span class="swal2-success-line-tip"></span> <span class="swal2-success-line-long"></span>\n       <div class="swal2-success-ring"></div> <div class="swal2-success-fix"></div>\n       <div class="swal2-success-circular-line-right"></div>\n     </div>\n     <img class="'+R.image+'" />\n     <h2 class="'+R.title+'" id="'+R.title+'"></h2>\n     <button type="button" class="'+R.close+'">×</button>\n   </div>\n   <div class="'+R.content+'">\n     <div id="'+R.content+'"></div>\n     <input class="'+R.input+'" />\n     <input type="file" class="'+R.file+'" />\n     <div class="'+R.range+'">\n       <input type="range" />\n       <output></output>\n     </div>\n     <select class="'+R.select+'"></select>\n     <div class="'+R.radio+'"></div>\n     <label for="'+R.checkbox+'" class="'+R.checkbox+'">\n       <input type="checkbox" />\n     </label>\n     <textarea class="'+R.textarea+'"></textarea>\n     <div class="'+R.validationerror+'" id="'+R.validationerror+'"></div>\n   </div>\n   <div class="'+R.actions+'">\n     <button type="button" class="'+R.confirm+'">OK</button>\n     <button type="button" class="'+R.cancel+'">Cancel</button>\n   </div>\n   <div class="'+R.footer+'">\n   </div>\n </div>\n').replace(/(^|\n)\s*/g,""),ie=function(e){var t=L();if(t&&(t.parentNode.removeChild(t),S([document.documentElement,document.body],[R["no-backdrop"],R["has-input"],R["toast-shown"]])),!y()){var n=document.createElement("div");n.className=R.container,n.innerHTML=w,("string"==typeof e.target?document.querySelector(e.target):e.target).appendChild(n);var o=Z(),r=$(),i=z(r,R.input),a=z(r,R.file),s=r.querySelector("."+R.range+" input"),u=r.querySelector("."+R.range+" output"),l=z(r,R.select),c=r.querySelector("."+R.checkbox+" input"),d=z(r,R.textarea);o.setAttribute("role",e.toast?"alert":"dialog"),o.setAttribute("aria-live",e.toast?"polite":"assertive"),e.toast||o.setAttribute("aria-modal","true");var p,f=function(e){we.isVisible()&&p!==e.target.value&&we.resetValidationError(),p=e.target.value};return i.oninput=f,a.onchange=f,l.onchange=f,c.onchange=f,d.oninput=f,s.oninput=function(){f(),u.value=s.value},s.onchange=function(){f(),s.nextSibling.value=s.value},o}H("SweetAlert2 requires document to initialize")},ae=function(e,t){if(!e)return F(t);if("object"===(void 0===e?"undefined":M(e)))if(t.innerHTML="",0 in e)for(var n=0;n in e;n++)t.appendChild(e[n].cloneNode(!0));else t.appendChild(e.cloneNode(!0));else e&&(t.innerHTML=e);U(t)},C=function(){if(y())return!1;var e=document.createElement("div"),t={WebkitAnimation:"webkitAnimationEnd",OAnimation:"oAnimationEnd oanimationend",animation:"animationend"};for(var n in t)if(t.hasOwnProperty(n)&&void 0!==e.style[n])return t[n];return!1}(),k=function(){null!==m.previousBodyPadding||document.body.scrollHeight>window.innerHeight&&(m.previousBodyPadding=parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),document.body.style.paddingRight=m.previousBodyPadding+function(){if("ontouchstart"in window||navigator.msMaxTouchPoints)return 0;var e=document.createElement("div");e.style.width="50px",e.style.height="50px",e.style.overflow="scroll",document.body.appendChild(e);var t=e.offsetWidth-e.clientWidth;return document.body.removeChild(e),t}()+"px")},se={},x=function(e,t){var n=L(),o=Z();if(o){null!==e&&"function"==typeof e&&e(o),S(o,R.show),W(o,R.hide);var r=function(){document.body.classList.contains(R["toast-shown"])||(function(){if(se.previousActiveElement&&se.previousActiveElement.focus){var e=se.previousActiveElement;se.previousActiveElement=null;var t=window.scrollX,n=window.scrollY;setTimeout(function(){e.focus&&e.focus()},100),void 0!==t&&void 0!==n&&window.scrollTo(t,n)}}(),window.removeEventListener("keydown",se.keydownHandler,{capture:!0}),se.keydownHandlerAdded=!1),n.parentNode&&n.parentNode.removeChild(n),S([document.documentElement,document.body],[R.shown,R["height-auto"],R["no-backdrop"],R["has-input"],R["toast-shown"]]),b()&&(null!==m.previousBodyPadding&&(document.body.style.paddingRight=m.previousBodyPadding,m.previousBodyPadding=null),function(){if(h(document.body,R.iosfix)){var e=parseInt(document.body.style.top,10);S(document.body,R.iosfix),document.body.style.top="",document.body.scrollTop=-1*e}}()),null!==t&&"function"==typeof t&&setTimeout(function(){t()})};C&&!h(o,R.noanimation)?o.addEventListener(C,function e(){o.removeEventListener(C,e),h(o,R.hide)&&r()}):r()}},A={title:"",titleText:"",text:"",html:"",footer:"",type:null,toast:!1,customClass:"",target:"body",backdrop:!0,animation:!0,heightAuto:!0,allowOutsideClick:!0,allowEscapeKey:!0,allowEnterKey:!0,showConfirmButton:!0,showCancelButton:!1,preConfirm:null,confirmButtonText:"OK",confirmButtonAriaLabel:"",confirmButtonColor:null,confirmButtonClass:null,cancelButtonText:"Cancel",cancelButtonAriaLabel:"",cancelButtonColor:null,cancelButtonClass:null,buttonsStyling:!0,reverseButtons:!1,focusConfirm:!0,focusCancel:!1,showCloseButton:!1,closeButtonAriaLabel:"Close this dialog",showLoaderOnConfirm:!1,imageUrl:null,imageWidth:null,imageHeight:null,imageAlt:"",imageClass:null,timer:null,width:null,padding:null,background:null,input:null,inputPlaceholder:"",inputValue:"",inputOptions:{},inputAutoTrim:!0,inputClass:null,inputAttributes:{},inputValidator:null,grow:!1,position:"center",progressSteps:[],currentProgressStep:null,progressStepsDistance:null,onBeforeOpen:null,onAfterClose:null,onOpen:null,onClose:null,useRejections:!1,expectRejections:!1},j=["useRejections","expectRejections"],T=function(e){return A.hasOwnProperty(e)||"extraParams"===e},_=function(e){return-1!==j.indexOf(e)},ue=function(e){for(var t in e)T(t)||B('Unknown parameter "'+t+'"'),_(t)&&d('The parameter "'+t+'" is deprecated and will be removed in the next major release.')},V={},le=[],ce=function(){var e=Z();e||we(""),e=Z();var t=te(),n=G(),o=ee();U(t),U(n),W([e,t],R.loading),n.disabled=!0,o.disabled=!0,e.setAttribute("data-loading",!0),e.setAttribute("aria-busy",!0),e.focus()},de=Object.freeze({isValidParameter:T,isDeprecatedParameter:_,argsToParams:function(n){var o={};switch(M(n[0])){case"string":["title","html","type"].forEach(function(e,t){switch(M(n[t])){case"string":o[e]=n[t];break;case"undefined":break;default:H("Unexpected type of "+e+'! Expected "string", got '+M(n[t]))}});break;case"object":a(o,n[0]);break;default:return H('Unexpected type of argument! Expected "string" or "object", got '+M(n[0])),!1}return o},adaptInputValidator:function(n){return function(e,t){return n.call(this,e,t).then(function(){},function(e){return e})}},close:x,closePopup:x,closeModal:x,closeToast:x,isVisible:function(){return!!Z()},clickConfirm:function(){return G().click()},clickCancel:function(){return ee().click()},getPopup:Z,getTitle:Y,getContent:$,getImage:J,getButtonsWrapper:function(){return d("swal.getButtonsWrapper() is deprecated and will be removed in the next major release, use swal.getActions() instead"),v(R.actions)},getActions:te,getConfirmButton:G,getCancelButton:ee,getFooter:ne,isLoading:function(){return Z().hasAttribute("data-loading")},mixin:function(n){var o=this;return e(function(e){function t(){return r(this,t),l(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return u(t,o),i(t,[{key:"_main",value:function(e){return s(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"_main",this).call(this,a({},n,e))}}]),t}())},queue:function(e){var i=this;le=e;var a=function(){le=[],document.body.removeAttribute("data-swal2-queue-step")},s=[];return new Promise(function(r){!function t(n,o){n<le.length?(document.body.setAttribute("data-swal2-queue-step",n),i(le[n]).then(function(e){void 0===e.value?(a(),r({dismiss:e.dismiss})):(s.push(e.value),t(n+1,o))})):(a(),r({value:s}))}(0)})},getQueueStep:function(){return document.body.getAttribute("data-swal2-queue-step")},insertQueueStep:function(e,t){return t&&t<le.length?le.splice(t,0,e):le.push(e)},deleteQueueStep:function(e){void 0!==le[e]&&le.splice(e,1)},showLoading:ce,enableLoading:ce,fire:function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];return new(Function.prototype.bind.apply(this,[null].concat(t)))}});if("undefined"!=typeof window&&"function"!=typeof window.WeakMap){var pe=0;window.Symbol=function(e){return"__"+e+"_"+Math.floor(1e9*Math.random())+"_"+ ++pe+"__"},Symbol.iterator=Symbol("Symbol.iterator"),window.WeakMap=function(n,o,t){function e(){o(this,n,{value:Symbol("WeakMap")})}return e.prototype={delete:function(e){delete e[this[n]]},get:function(e){return e[this[n]]},has:function(e){return t.call(e,this[n])},set:function(e,t){o(e,this[n],{configurable:!0,value:t})}},e}(Symbol("WeakMap"),Object.defineProperty,{}.hasOwnProperty)}var fe={promise:new WeakMap,innerParams:new WeakMap,domCache:new WeakMap},me={email:function(e,t){return/^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(e)?Promise.resolve():Promise.reject(t&&t.validationMessage?t.validationMessage:"Invalid email address")},url:function(e,t){return/^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)$/.test(e)?Promise.resolve():Promise.reject(t&&t.validationMessage?t.validationMessage:"Invalid URL")}},he=function(e){var t=L(),n=Z();null!==e.onBeforeOpen&&"function"==typeof e.onBeforeOpen&&e.onBeforeOpen(n),e.animation?(W(n,R.show),W(t,R.fade),S(n,R.hide)):S(n,R.fade),U(n),t.style.overflowY="hidden",C&&!h(n,R.noanimation)?n.addEventListener(C,function e(){n.removeEventListener(C,e),t.style.overflowY="auto"}):t.style.overflowY="auto",W([document.documentElement,document.body,t],R.shown),e.heightAuto&&e.backdrop&&!e.toast&&W([document.documentElement,document.body],R["height-auto"]),b()&&(k(),function(){if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&!h(document.body,R.iosfix)){var e=document.body.scrollTop;document.body.style.top=-1*e+"px",W(document.body,R.iosfix)}}()),se.previousActiveElement||(se.previousActiveElement=document.activeElement),null!==e.onOpen&&"function"==typeof e.onOpen&&setTimeout(function(){e.onOpen(n)})},ge=Object.freeze({hideLoading:t,disableLoading:t,getInput:function(e){var t=fe.innerParams.get(this),n=fe.domCache.get(this);return(e=e||t.input)?"select"===e||"textarea"===e||"file"===e?z(n.content,R[e]):"checkbox"===e?n.popup.querySelector("."+R.checkbox+" input"):"radio"===e?n.popup.querySelector("."+R.radio+" input:checked")||n.popup.querySelector("."+R.radio+" input:first-child"):"range"===e?n.popup.querySelector("."+R.range+" input"):z(n.content,R.input):null},enableButtons:function(){var e=fe.domCache.get(this);e.confirmButton.disabled=!1,e.cancelButton.disabled=!1},disableButtons:function(){var e=fe.domCache.get(this);e.confirmButton.disabled=!0,e.cancelButton.disabled=!0},enableConfirmButton:function(){fe.domCache.get(this).confirmButton.disabled=!1},disableConfirmButton:function(){fe.domCache.get(this).confirmButton.disabled=!0},enableInput:function(){var e=this.getInput();if(!e)return!1;if("radio"===e.type)for(var t=e.parentNode.parentNode.querySelectorAll("input"),n=0;n<t.length;n++)t[n].disabled=!1;else e.disabled=!1},disableInput:function(){var e=this.getInput();if(!e)return!1;if(e&&"radio"===e.type)for(var t=e.parentNode.parentNode.querySelectorAll("input"),n=0;n<t.length;n++)t[n].disabled=!0;else e.disabled=!0},showValidationError:function(e){var t=fe.domCache.get(this);t.validationError.innerHTML=e;var n=window.getComputedStyle(t.popup);t.validationError.style.marginLeft="-"+n.getPropertyValue("padding-left"),t.validationError.style.marginRight="-"+n.getPropertyValue("padding-right"),U(t.validationError);var o=this.getInput();o&&(o.setAttribute("aria-invalid",!0),o.setAttribute("aria-describedBy",R.validationerror),N(o),W(o,R.inputerror))},resetValidationError:function(){var e=fe.domCache.get(this);e.validationError&&F(e.validationError);var t=this.getInput();t&&(t.removeAttribute("aria-invalid"),t.removeAttribute("aria-describedBy"),S(t,R.inputerror))},_main:function(e){var j=this;ue(e);var T=a({},A,e);(function(r){r.inputValidator||Object.keys(me).forEach(function(e){r.input===e&&(r.inputValidator=r.expectRejections?me[e]:we.adaptInputValidator(me[e]))}),r.target&&("string"!=typeof r.target||document.querySelector(r.target))&&("string"==typeof r.target||r.target.appendChild)||(B('Target parameter is not valid, defaulting to "body"'),r.target="body");var e,t=Z(),n="string"==typeof r.target?document.querySelector(r.target):r.target;e=t&&n&&t.parentNode!==n.parentNode?ie(r):t||ie(r),r.width&&(e.style.width="number"==typeof r.width?r.width+"px":r.width),r.padding&&(e.style.padding="number"==typeof r.padding?r.padding+"px":r.padding),r.background&&(e.style.background=r.background);for(var o=window.getComputedStyle(e).getPropertyValue("background-color"),i=e.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"),a=0;a<i.length;a++)i[a].style.backgroundColor=o;var s=L(),u=Y(),l=$().querySelector("#"+R.content),c=te(),d=G(),p=ee(),f=oe(),m=ne();if(r.titleText?u.innerText=r.titleText:r.title&&(u.innerHTML=r.title.split("\n").join("<br />")),"string"==typeof r.backdrop?L().style.background=r.backdrop:!r.backdrop&&W([document.documentElement,document.body],R["no-backdrop"]),r.html?ae(r.html,l):r.text?(l.textContent=r.text,U(l)):F(l),r.position in R?W(s,R[r.position]):(B('The "position" parameter is not valid, defaulting to "center"'),W(s,R.center)),r.grow&&"string"==typeof r.grow){var h="grow-"+r.grow;h in R&&W(s,R[h])}"function"==typeof r.animation&&(r.animation=r.animation.call()),r.showCloseButton?(f.setAttribute("aria-label",r.closeButtonAriaLabel),U(f)):F(f),e.className=R.popup,r.toast?(W([document.documentElement,document.body],R["toast-shown"]),W(e,R.toast)):W(e,R.modal),r.customClass&&W(e,r.customClass);var g=X(),v=parseInt(null===r.currentProgressStep?we.getQueueStep():r.currentProgressStep,10);r.progressSteps&&r.progressSteps.length?(U(g),P(g),v>=r.progressSteps.length&&B("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),r.progressSteps.forEach(function(e,t){var n=document.createElement("li");if(W(n,R.progresscircle),n.innerHTML=e,t===v&&W(n,R.activeprogressstep),g.appendChild(n),t!==r.progressSteps.length-1){var o=document.createElement("li");W(o,R.progressline),r.progressStepsDistance&&(o.style.width=r.progressStepsDistance),g.appendChild(o)}})):F(g);for(var b=Q(),y=0;y<b.length;y++)F(b[y]);if(r.type){var w=!1;for(var C in E)if(r.type===C){w=!0;break}if(!w)return H("Unknown alert type: "+r.type);var k=e.querySelector("."+R.icon+"."+E[r.type]);U(k),r.animation&&W(k,"swal2-animate-"+r.type+"-icon")}var x=J();if(r.imageUrl?(x.setAttribute("src",r.imageUrl),x.setAttribute("alt",r.imageAlt),U(x),r.imageWidth?x.setAttribute("width",r.imageWidth):x.removeAttribute("width"),r.imageHeight?x.setAttribute("height",r.imageHeight):x.removeAttribute("height"),x.className=R.image,r.imageClass&&W(x,r.imageClass)):F(x),r.showCancelButton?p.style.display="inline-block":F(p),r.showConfirmButton?O(d,"display"):F(d),r.showConfirmButton||r.showCancelButton?U(c):F(c),d.innerHTML=r.confirmButtonText,p.innerHTML=r.cancelButtonText,d.setAttribute("aria-label",r.confirmButtonAriaLabel),p.setAttribute("aria-label",r.cancelButtonAriaLabel),d.className=R.confirm,W(d,r.confirmButtonClass),p.className=R.cancel,W(p,r.cancelButtonClass),r.buttonsStyling){W([d,p],R.styled),r.confirmButtonColor&&(d.style.backgroundColor=r.confirmButtonColor),r.cancelButtonColor&&(p.style.backgroundColor=r.cancelButtonColor);var A=window.getComputedStyle(d).getPropertyValue("background-color");d.style.borderLeftColor=A,d.style.borderRightColor=A}else S([d,p],R.styled),d.style.backgroundColor=d.style.borderLeftColor=d.style.borderRightColor="",p.style.backgroundColor=p.style.borderLeftColor=p.style.borderRightColor="";ae(r.footer,m),!0===r.animation?S(e,R.noanimation):W(e,R.noanimation),r.showLoaderOnConfirm&&!r.preConfirm&&B("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request")})(T),Object.freeze(T),fe.innerParams.set(this,T),clearTimeout(se.timeout);var _={popup:Z(),container:L(),content:$(),actions:te(),confirmButton:G(),cancelButton:ee(),closeButton:oe(),validationError:v(R.validationerror),progressSteps:X()};fe.domCache.set(this,_);var V=this.constructor;return new Promise(function(t,n){var o=function(e){V.closePopup(T.onClose,T.onAfterClose),T.useRejections?t(e):t({value:e})},l=function(e){V.closePopup(T.onClose,T.onAfterClose),T.useRejections?n(e):t({dismiss:e})},c=function(e){V.closePopup(T.onClose,T.onAfterClose),n(e)};T.timer&&(se.timeout=setTimeout(function(){return l("timer")},T.timer));T.input&&setTimeout(function(){var e=j.getInput();e&&N(e)},0);for(var d=function(t){if(T.showLoaderOnConfirm&&V.showLoading(),T.preConfirm){j.resetValidationError();var e=Promise.resolve().then(function(){return T.preConfirm(t,T.extraParams)});T.expectRejections?e.then(function(e){return o(e||t)},function(e){j.hideLoading(),e&&j.showValidationError(e)}):e.then(function(e){K(_.validationError)||!1===e?j.hideLoading():o(e||t)},function(e){return c(e)})}else o(t)},e=function(e){var t=e||window.event,n=t.target||t.srcElement,o=_.confirmButton,r=_.cancelButton,i=o&&(o===n||o.contains(n)),a=r&&(r===n||r.contains(n));switch(t.type){case"click":if(i&&V.isVisible())if(j.disableButtons(),T.input){var s=function(){var e=j.getInput();if(!e)return null;switch(T.input){case"checkbox":return e.checked?1:0;case"radio":return e.checked?e.value:null;case"file":return e.files.length?e.files[0]:null;default:return T.inputAutoTrim?e.value.trim():e.value}}();if(T.inputValidator){j.disableInput();var u=Promise.resolve().then(function(){return T.inputValidator(s,T.extraParams)});T.expectRejections?u.then(function(){j.enableButtons(),j.enableInput(),d(s)},function(e){j.enableButtons(),j.enableInput(),e&&j.showValidationError(e)}):u.then(function(e){j.enableButtons(),j.enableInput(),e?j.showValidationError(e):d(s)},function(e){return c(e)})}else d(s)}else d(!0);else a&&V.isVisible()&&(j.disableButtons(),l(V.DismissReason.cancel))}},r=_.popup.querySelectorAll("button"),i=0;i<r.length;i++)r[i].onclick=e,r[i].onmouseover=e,r[i].onmouseout=e,r[i].onmousedown=e;if(_.closeButton.onclick=function(){l(V.DismissReason.close)},T.toast)_.popup.onclick=function(){T.showConfirmButton||T.showCancelButton||T.showCloseButton||T.input||(V.closePopup(T.onClose,T.onAfterClose),l(V.DismissReason.close))};else{var a=!1;_.popup.onmousedown=function(){_.container.onmouseup=function(e){_.container.onmouseup=void 0,e.target===_.container&&(a=!0)}},_.container.onmousedown=function(){_.popup.onmouseup=function(e){_.popup.onmouseup=void 0,(e.target===_.popup||_.popup.contains(e.target))&&(a=!0)}},_.container.onclick=function(e){return a?void(a=!1):void(e.target!==_.container||I(T.allowOutsideClick)&&l(V.DismissReason.backdrop))}}T.reverseButtons?_.confirmButton.parentNode.insertBefore(_.cancelButton,_.confirmButton):_.confirmButton.parentNode.insertBefore(_.confirmButton,_.cancelButton);var s,u=function(e,t){for(var n=re(T.focusCancel),o=0;o<n.length;o++){(e+=t)===n.length?e=0:-1===e&&(e=n.length-1);var r=n[e];if(K(r))return r.focus()}_.popup.focus()};se.keydownHandlerAdded&&(window.removeEventListener("keydown",se.keydownHandler,{capture:!0}),se.keydownHandlerAdded=!1),T.toast||(se.keydownHandler=function(e){return function(e,t){if(e.stopPropagation(),"Enter"!==e.key||e.isComposing)if("Tab"===e.key){for(var n=e.target||e.srcElement,o=re(t.focusCancel),r=-1,i=0;i<o.length;i++)if(n===o[i]){r=i;break}e.shiftKey?u(r,-1):u(r,1),e.stopPropagation(),e.preventDefault()}else-1===["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Left","Right","Up","Down"].indexOf(e.key)?("Escape"===e.key||"Esc"===e.key)&&!0===I(t.allowEscapeKey)&&l(V.DismissReason.esc):document.activeElement===_.confirmButton&&K(_.cancelButton)?_.cancelButton.focus():document.activeElement===_.cancelButton&&K(_.confirmButton)&&_.confirmButton.focus();else if(e.target&&j.getInput()&&e.target.outerHTML===j.getInput().outerHTML){if(-1!==["textarea","file"].indexOf(t.input))return;V.clickConfirm(),e.preventDefault()}}(e,T)},window.addEventListener("keydown",se.keydownHandler,{capture:!0}),se.keydownHandlerAdded=!0),j.enableButtons(),j.hideLoading(),j.resetValidationError(),T.input&&W(document.body,R["has-input"]);for(var p=["input","file","range","select","radio","checkbox","textarea"],f=void 0,m=0;m<p.length;m++){var h=R[p[m]],g=z(_.content,h);if(f=j.getInput(p[m])){for(var v in f.attributes)if(f.attributes.hasOwnProperty(v)){var b=f.attributes[v].name;"type"!==b&&"value"!==b&&f.removeAttribute(b)}for(var y in T.inputAttributes)f.setAttribute(y,T.inputAttributes[y])}g.className=h,T.inputClass&&W(g,T.inputClass),F(g)}switch(T.input){case"text":case"email":case"password":case"number":case"tel":case"url":(f=z(_.content,R.input)).value=T.inputValue,f.placeholder=T.inputPlaceholder,f.type=T.input,U(f);break;case"file":(f=z(_.content,R.file)).placeholder=T.inputPlaceholder,f.type=T.input,U(f);break;case"range":var w=z(_.content,R.range),C=w.querySelector("input"),k=w.querySelector("output");C.value=T.inputValue,C.type=T.input,k.value=T.inputValue,U(w);break;case"select":var x=z(_.content,R.select);if(x.innerHTML="",T.inputPlaceholder){var A=document.createElement("option");A.innerHTML=T.inputPlaceholder,A.value="",A.disabled=!0,A.selected=!0,x.appendChild(A)}s=function(e){e.forEach(function(e){var t=q(e,2),n=t[0],o=t[1],r=document.createElement("option");r.value=n,r.innerHTML=o,T.inputValue.toString()===n.toString()&&(r.selected=!0),x.appendChild(r)}),U(x),x.focus()};break;case"radio":var B=z(_.content,R.radio);B.innerHTML="",s=function(e){e.forEach(function(e){var t=q(e,2),n=t[0],o=t[1],r=document.createElement("input"),i=document.createElement("label");r.type="radio",r.name=R.radio,r.value=n,T.inputValue.toString()===n.toString()&&(r.checked=!0),i.innerHTML=o,i.insertBefore(r,i.firstChild),B.appendChild(i)}),U(B);var t=B.querySelectorAll("input");t.length&&t[0].focus()};break;case"checkbox":var E=z(_.content,R.checkbox),S=j.getInput("checkbox");S.type="checkbox",S.value=1,S.id=R.checkbox,S.checked=!!T.inputValue;var P=E.getElementsByTagName("span");P.length&&E.removeChild(P[0]),(P=document.createElement("span")).innerHTML=T.inputPlaceholder,E.appendChild(P),U(E);break;case"textarea":var O=z(_.content,R.textarea);O.value=T.inputValue,O.placeholder=T.inputPlaceholder,U(O);break;case null:break;default:H('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'+T.input+'"')}if("select"===T.input||"radio"===T.input){var L=function(e){return s((t=e,n=[],"undefined"!=typeof Map&&t instanceof Map?t.forEach(function(e,t){n.push([t,e])}):Object.keys(t).forEach(function(e){n.push([e,t[e]])}),n));var t,n};D(T.inputOptions)?(V.showLoading(),T.inputOptions.then(function(e){j.hideLoading(),L(e)})):"object"===M(T.inputOptions)?L(T.inputOptions):H("Unexpected type of inputOptions! Expected object, Map or Promise, got "+M(T.inputOptions))}else-1!==["text","email","number","tel","textarea"].indexOf(T.input)&&D(T.inputValue)&&(V.showLoading(),F(f),T.inputValue.then(function(e){f.value="number"===T.input?parseFloat(e)||0:e+"",U(f),j.hideLoading()}).catch(function(e){H("Error in inputValue promise: "+e),f.value="",U(f),j.hideLoading()}));he(T),T.toast||(I(T.allowEnterKey)?T.focusCancel&&K(_.cancelButton)?_.cancelButton.focus():T.focusConfirm&&K(_.confirmButton)?_.confirmButton.focus():u(-1,1):document.activeElement&&document.activeElement.blur()),_.container.scrollTop=0})}}),ve=void 0;n.prototype.then=function(e,t){return fe.promise.get(this).then(e,t)},n.prototype.catch=function(e){return fe.promise.get(this).catch(e)},n.prototype.finally=function(e){return fe.promise.get(this).finally(e)},a(n.prototype,ge),a(n,de),Object.keys(ge).forEach(function(t){n[t]=function(){var e;if(ve)return(e=ve)[t].apply(e,arguments)}}),n.DismissReason=p,n.noop=function(){},n.version="7.21.1";var be,ye,we=e((be=n,ye=function(e){function t(){return r(this,t),l(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return u(t,be),i(t,[{key:"_main",value:function(e){return s(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"_main",this).call(this,a({},V,e))}}],[{key:"setDefaults",value:function(t){if(d('"setDefaults" & "resetDefaults" methods are deprecated in favor of "mixin" method and will be removed in the next major release. For new projects, use "mixin". For past projects already using "setDefaults", support will be provided through an additional package.'),!t||"object"!==(void 0===t?"undefined":M(t)))throw new TypeError("SweetAlert2: The argument for setDefaults() is required and has to be a object");ue(t),Object.keys(t).forEach(function(e){be.isValidParameter(e)&&(V[e]=t[e])})}},{key:"resetDefaults",value:function(){d('"setDefaults" & "resetDefaults" methods are deprecated in favor of "mixin" method and will be removed in the next major release. For new projects, use "mixin". For past projects already using "setDefaults", support will be provided through an additional package.'),V={}}}]),t}(),"undefined"!=typeof window&&"object"===M(window._swalDefaults)&&ye.setDefaults(window._swalDefaults),ye));return we.default=we}),"undefined"!=typeof window&&window.Sweetalert2&&(window.swal=window.sweetAlert=window.Swal=window.SweetAlert=window.Sweetalert2);
var onloadCallback=function(){opt_grecaptcha=grecaptcha.render("g-recaptcha",{sitekey:'6Ldy_lsUAAAAAF1U6ABYE_7-bpAlGN_ray6F0KZV"'})};$(document).ready(function(){$.validate({modules:"security"}),$("#modal-video").on("hidden.bs.modal",function(a){var e=$("#modal-video .modal-body .embed-responsive-item").attr("src");$("#modal-video .modal-body .embed-responsive-item").attr("src",e)}),$("#form-pre-register").submit(function(a){a.preventDefault(),$.ajax({cache:!1,type:$(this).attr("method"),url:$(this).attr("action"),data:$(this).serialize(),success:function(a){var e=jQuery.parseJSON(a);grecaptcha.reset(opt_grecaptcha),e.status?($("#form-pre-register")[0].reset(),swal({title:e.message,type:"success",timer:3e3,showConfirmButton:!1})):swal({title:e.message,type:"error",timer:3e3,showConfirmButton:!1})}})}),$("[data-dinaanim]").each(function(){var e=$(this);e.addClass("dinaAnim-invisible"),767<$(window).width()?e.appear(function(){var a=e.data("dinadelay")?e.data("dinadelay"):1;1<a&&e.css("animation-delay",a+"ms"),e.addClass("dinaAnim-animated"),e.addClass("dinaAnim-"+e.data("dinaanim")),setTimeout(function(){e.addClass("dinaAnim-visible")},a)},{accX:0,accY:-150}):e.animate({opacity:1},300,"easeInOutQuad",function(){})})});