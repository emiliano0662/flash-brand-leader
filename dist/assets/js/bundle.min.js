...
var onloadCallback=function(){opt_grecaptcha=grecaptcha.render("g-recaptcha",{sitekey:'6Ldy_lsUAAAAAF1U6ABYE_7-bpAlGN_ray6F0KZV"'})};$(document).ready(function(){$.validate({modules:"security"}),$("#form-pre-register").submit(function(a){a.preventDefault(),$.ajax({cache:!1,type:$(this).attr("method"),url:$(this).attr("action"),data:$(this).serialize(),success:function(a){var t=jQuery.parseJSON(a);grecaptcha.reset(opt_grecaptcha),t.status?($("#form-pre-register")[0].reset(),swal({title:t.message,type:"success",timer:3e3,showConfirmButton:!1})):swal({title:t.message,type:"error",timer:3e3,showConfirmButton:!1})}})}),$("[data-dinaanim]").each(function(){var t=$(this);t.addClass("dinaAnim-invisible"),767<$(window).width()?t.appear(function(){var a=t.data("dinadelay")?t.data("dinadelay"):1;1<a&&t.css("animation-delay",a+"ms"),t.addClass("dinaAnim-animated"),t.addClass("dinaAnim-"+t.data("dinaanim")),setTimeout(function(){t.addClass("dinaAnim-visible")},a)},{accX:0,accY:-150}):t.animate({opacity:1},300,"easeInOutQuad",function(){})})});